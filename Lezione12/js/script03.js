...
let btnPrefCanc = document.querySelector("#btnPrefCanc");
let commentiPrefBox = document.querySelector("#commentiPrefBox");
let commentiPrefArea = document.querySelector("#commentiPrefArea");
...
function mostraCommPref(){
    ...
    commentiPrefArea.appendChild(ul);
...
function caricaDati(){
    ...
    if(localStorage.getItem("commentiPref")){
        ...
        btnPrefCanc.classList.replace("hide", "show");
    }else{
        btnPref.classList.replace("show", "hide");
        btnPrefCanc.classList.replace("show", "hide");
    }
...
btnPrefCanc.addEventListener("click", cancellaPreferiti)

function cancellaPreferiti() {
    localStorage.setItem("commentiPref", "")
    btnPref.classList.replace("show", "hide");
    btnPrefCanc.classList.replace("show", "hide");
    commentiPreferiti = [];
    commentiPrefArea.innerHTML = "";
    commentoUtente.innerHTML = "";
}
